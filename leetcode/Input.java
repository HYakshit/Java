...
public class Input {
    ...
    static int[] singleArr = {5};
    static int[] arr1 = {2, 5, 6, 7};
    static int[] arr2 = {2, 6, 3, 1, 7};
    static int[] unique1 = {2, 6, 7};
    static int[] unique2Arr = {9, 1, 4, 3, 8};
    ...
    static String spacenum = "          99";
    static String numstr2 = "987654321";
    static String str1 = "akshit";
